...
class OfferFeedGateLostClaimTest {
    ...
    fun `lost-claim re-publish drops blank and fee-wallet addresses`() {
        assertNull(OfferFeedGate.lostClaimBuyerAddress("", "bc1qdfs8ucuq8dm3k3tfuzlvhfyevhs0swz4098fwk"))
        assertNull(OfferFeedGate.lostClaimBuyerAddress("  ", "bc1qdfs8ucuq8dm3k3tfuzlvhfyevhs0swz4098fwk"))
        assertNull(OfferFeedGate.lostClaimBuyerAddress(null, "bc1qdfs8ucuq8dm3k3tfuzlvhfyevhs0swz4098fwk"))
