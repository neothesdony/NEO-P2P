...
| Chain reorg / un-confirm | Conf depth from tip height; no reorg window tracking after FUNDED | E7 UNKNOWN — FUNDED is one-shot; a reorg that un-confirms the funding tx is not re-checked |
